...
def list_accounts():
    ...
    app.logger.info("Returns list of all accounts")
...
def read_account(id):
    ...
    app.logger.info("Reads an account with the id submitted")
...
def update_account(id):
    ...
    app.logger.info("Updates an account with id %s", id)
...
def delete_account(id):
    ...
    app.logger.info("Delete an account with id %s", id)
